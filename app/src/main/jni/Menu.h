...
Java_dev_seyz_modmenu_FloatingModMenuService_setTitleText(JNIEnv *env, jobject thiz, jobject obj) {
    setText(env, obj, OBFUSCATE("<b>Mod menu</b>"));

    titleValid = true;
}

JNIEXPORT void JNICALL
Java_dev_seyz_modmenu_FloatingModMenuService_setHeadingText(JNIEnv *env, jobject thiz, jobject obj) {
    setText(env, obj, OBFUSCATE("<b><marquee><p style=\"font-size:30\">"
                                      "<p>Modded by Seyz</p> | "
                                      "https://github.com/Seyz123</p>"
                                      "</marquee></b>"));
...
Java_dev_seyz_modmenu_FloatingModMenuService_Icon(JNIEnv *env, jobject thiz) {
    iconValid = true;
...
JNIEXPORT jstring JNICALL
Java_dev_seyz_modmenu_FloatingModMenuService_IconWebViewData(JNIEnv *env, jobject thiz) {
    iconValid = true;
...
Java_dev_seyz_modmenu_FloatingModMenuService_settingsList(JNIEnv *env, jobject activityObject) {
    jobjectArray ret;
